...
export default function Animation() {
   ...
   return (
      ...
      >
         ...
         <span className="circle absolute top-52 md:top-72 left-52 md:left-96 aspect-square h-32 md:h-60 rounded-full bg-amber-400/40 blur-2xl block"></span>
         ...
         <span className="circle absolute top-40 md:top-10 right-40 md:right-60 aspect-square h-60 md:h-96 rounded-full bg-purple-400/40 blur-2xl block"></span>
      </div>
   );
}
